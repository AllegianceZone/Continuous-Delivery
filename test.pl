...
my $wut = Win32::Process::Create($ProcessObj,$ARGV[0],$ARGV[1],0,NORMAL_PRIORITY_CLASS,$ARGV[2]) || die ErrorReport();
$wut = ($ARGV[3]) ? $ProcessObj->Wait(INFINITE) : $ProcessObj->Wait(30 * 1000);
