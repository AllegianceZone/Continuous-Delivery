...
my $cmd = "copy C:\\build\\Allegiance\\objs10\\FZDebug\\AGC\\AGC.dll C:\\AllegBeta\\AGC.dll /Y";
`$cmd`;
my $cmd = "copy C:\\build\\Allegiance\\objs10\\FZDebug\\FedSrv\\AllSrv.exe C:\\AllegBeta\\AllSrv.exe /Y";
`$cmd`;
my $cmd = "copy C:\\build\\Allegiance\\objs10\\FZDebug\\Lobby\\AllLobby.exe C:\\AllegBeta\\AllLobby.exe /Y";
`$cmd`;
my $cmd = "copy C:\\build\\Allegiance\\objs10\\FZDebug\\AGC\\AGC.pdb C:\\AllegBeta\\AGC.pdb /Y";
`$cmd`;
my $cmd = "copy C:\\build\\Allegiance\\objs10\\FZDebug\\FedSrv\\AllSrv.pdb C:\\AllegBeta\\AllSrv.pdb /Y";
`$cmd`;
my $cmd = "copy C:\\build\\Allegiance\\objs10\\FZDebug\\Lobby\\AllLobby.pdb C:\\AllegBeta\\AllLobby.pdb /Y";
`$cmd`;

my $cmd = "copy C:\\build\\Artwork C:\\AllegBeta\\Artwork /Y";
`$cmd`;

my $cmd = "copy C:\\build\\Allegiance\\Artwork C:\\AllegBeta\\Artwork /Y";
`$cmd`;
